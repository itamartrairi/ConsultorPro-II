          ...
          {activeTab === 'visao-geral' && (
            <div className="space-y-6">
              ...
              <motion.div 
                ...
                className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 space-y-6"
              >
                {/* Header Row */}
                ...
                {taskAnalytics.total === 0 ? (
                  <motion.div 
                    ...
                    className="py-8 text-center bg-slate-50/50 rounded-2xl border border-slate-100/60 p-6 flex flex-col items-center justify-center"
                  >
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div
                      key={`tasks-content-${taskDeadlineFilter}-${taskAnalytics.total}`}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-5 gap-3">
                        ...
                        <motion.div 
                          ...
                          className="bg-slate-50/70 border border-slate-100 rounded-2xl p-3.5 flex flex-col justify-between"
                        >
                          <div className="flex items-center justify-between text-slate-400 mb-1">
                        ...
                        <motion.div 
                          ...
                          className="bg-amber-50/40 border border-amber-100/60 rounded-2xl p-3.5 flex flex-col justify-between"
                        >
                        ...
                        <motion.div 
                          ...
                          className="bg-blue-50/40 border border-blue-100/60 rounded-2xl p-3.5 flex flex-col justify-between"
                        >
                        ...
                        <motion.div 
                          ...
                          className="bg-emerald-50/40 border border-emerald-100/60 rounded-2xl p-3.5 flex flex-col justify-between"
                        >
                      ...
                      <div className="space-y-1.5 pt-1">
                        ...
                        <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden flex p-0.5 gap-0.5">
                          {taskAnalytics.concluidas > 0 && (
                            <motion.div 
                              initial={{ width: 0 }}
                              animate={{ width: `${(taskAnalytics.concluidas / taskAnalytics.total) * 100}%` }}
                          ...
                          {taskAnalytics.emAndamento > 0 && (
                            <motion.div 
                              initial={{ width: 0 }}
                              animate={{ width: `${(taskAnalytics.emAndamento / taskAnalytics.total) * 100}%` }}
                          ...
                          {taskAnalytics.pendentes > 0 && (
                            <motion.div 
                              initial={{ width: 0 }}
                              animate={{ width: `${(taskAnalytics.pendentes / taskAnalytics.total) * 100}%` }}
                          ...
                          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
                            {taskAnalytics.deadlineChartData.map((d, i) => (
                              <motion.div 
                                ...
                                className={cn("px-2 py-1.5 rounded-xl border text-center", d.badge)}
                              >
                            ...
                            {(() => {
                              ...
                              if (filteredUpcoming.length === 0) {
                                return (
                                  <motion.div 
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    className="py-8 text-center bg-slate-50/50 rounded-xl border border-slate-100 text-slate-400 text-xs font-sans italic"
                                  >
                              ...
                              return (
                                <AnimatePresence mode="popLayout">
                                  {filteredUpcoming.slice(0, 10).map((t, idx) => {
