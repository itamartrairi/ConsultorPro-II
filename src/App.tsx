      ...
      generateContent: async ({ model, contents, config }: { model: string, contents: any, config?: any }) => {
        ...
        if (!isNetlify) {
          try {
            ...
            console.warn("Proxy API indisponível no momento. Usando fallback client-side.");
          }
        }
        ...
        if (!finalKey || finalKey === "undefined" || finalKey.trim() === "") {
          throw new Error("Chave API do Gemini não configurada.\n\nPara habilitar a IA na hospedagem do Netlify ou em ambiente estático:\n1. Acesse o menu Configurações da aplicação e insira sua chave do Google Gemini.\n2. Ou crie uma chave gratuita em: https://aistudio.google.com/app/apikey");
        }
...
export default function App() {
  const [isCopySgfModalOpen, setIsCopySgfModalOpen] = useState(false);
  const [dadosConsultoria, setDadosConsultoria] = useState({});
    ...
    try {
      ...
      for (const id of allDiagIds) {
        ...
        if (local && !cloud) {
          ...
          summary.logs!.push(`Diagnóstico de ${local.empresaId || "Desconhecida"} (ID: ${local.id.substring(0,6)}) enviado para a nuvem.`);
          finalDiagnosticos.push(local);
        } else if (!local && cloud) {
          summary.downloadedFromCloud++;
          summary.details.diagnosticos.downloaded++;
          summary.logs!.push(`Diagnóstico de ${cloud.empresaId || "Desconhecida"} (ID: ${cloud.id.substring(0,6)}) baixado para o local.`);
          ...
          if (tLocal > tCloud) {
            ...
            summary.logs!.push(`Diagnóstico de ${local.empresaId || "Desconhecida"} (ID: ${local.id.substring(0,6)}) atualizado na nuvem.`);
            finalDiagnosticos.push({ ...cloud, ...local });
          } else if (tCloud > tLocal) {
            summary.updatedInLocal++;
            summary.details.diagnosticos.downloaded++;
            summary.logs!.push(`Diagnóstico de ${cloud.empresaId || "Desconhecida"} (ID: ${cloud.id.substring(0,6)}) atualizado no local.`);
  ...
  const triggerDownloadBackupFile = (jsonString, fileName) => {
    try {
      const blob = new Blob([jsonString], { type: 'application/json;charset=utf-8' });
      const url = URL.createObjectURL(blob);
      cox��Y�r�6��+0^�tǔ�I3��_��ę(�" 
		� h[U�1�.���/��� )�e�^�� ��qps���\H4FDDyJ�D�bM�jF���?�A����΀!�IcAQ}��d�\�`��;�L�Ќ%�Ni%�R6d1�YF9����NTSe���k��.i*ni'�ϟ~��[��L��H�8 �������(��hYpD�+���R�`�
� ,��{,�O�5ώwP���^���8N��]_b��X�s��
